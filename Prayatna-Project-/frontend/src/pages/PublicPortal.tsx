...
function DoctorAvatar({ initials, status }: { initials: string; status: 'on-duty' | 'off-duty' }) {
  ...
  return (
    <div className="relative inline-block">
      ...
      <span
        className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full border-2 border-[#10362e] ${
...
function KnowMoreModal({
  ...
  return (
    <div
      className="fixed inset-0 z-[9999] flex items-center justify-center bg-[#051510]/85 backdrop-blur-md p-4"
      onClick={onClose}
    >
      <div
        className="relative bg-gradient-to-b from-[#113c33] to-[#0c2a23] border border-teal-700/40 rounded-2xl w-full max-w-3xl max-h-[92vh] overflow-y-auto shadow-[0_0_80px_rgba(20,184,166,0.18)] customized-scrollbar"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Modal Header */}
        <div className="sticky top-0 z-10 bg-[#113c33]/95 backdrop-blur-sm border-b border-teal-800/40 px-6 py-4 flex items-start justify-between">
          <div>
...
function DoctorCard({ doc }: { doc: Doctor }) {
  return (
    <div className={`flex items-center gap-3 bg-[#0d2e27] border rounded-xl p-3 transition-all ${doc.status === 'on-duty' ? 'border-emerald-800/30' : 'border-gray-800/40'}`}>
...
function ExpandedHospitalCard({
  ...
  return (
    <div className="bg-gradient-to-br from-[#143f39] to-[#10352c] border border-teal-500/40 rounded-xl p-4 shadow-[0_0_24px_rgba(20,184,166,0.18)] transition-all">
      {/* Header */}
      ...
      <div className="grid grid-cols-3 gap-1.5 mb-3">
        {[
          ...
          <div key={r.label} className={`rounded-lg p-1.5 flex items-center justify-between border ${r.good ? 'bg-[#071e17] border-teal-900/30' : 'bg-rose-950/10 border-rose-900/20'}`}>
...
function CollapsedHospitalCard({
  ...
  return (
    <div
      onClick={onClick}
      className={`bg-gradient-to-br from-[#134036] to-[#0d2f28] border ${isSelected ? 'border-rose-500 shadow-[0_0_15px_rgba(244,63,94,0.2)]' : 'border-teal-800/40 hover:border-teal-500/60'} rounded-xl p-4 shadow-lg transition-all cursor-pointer group`}
    >
      ...
      <div className="grid grid-cols-2 gap-y-2 gap-x-2 text-[10px] font-bold mb-4">
        <div className="bg-[#071e17] rounded p-1.5 flex items-center justify-between border border-teal-900/30 shadow-inner">
      ...
      <div className="grid grid-cols-4 gap-2 mt-4">
        <button onClick={(e) => { e.stopPropagation(); onNavigate(hospital); }} className="flex flex-col items-center justify-center gap-1 p-1.5 rounded-lg bg-[#0c2a23] hover:bg-teal-900 border border-teal-800/40 hover:border-teal-500/40 transition-all text-teal-300">
          <Navigation className="w-3.5 h-3.5 hover:text-white" />
          <span className="text-[9px] font-bold uppercase tracking-wider">Nav</span>
        </button>
        <button onClick={(e) => { e.stopPropagation(); onCall(hospital); }} className="flex flex-col items-center justify-center gap-1 p-1.5 rounded-lg bg-[#0c2a23] hover:bg-teal-900 border border-teal-800/40 hover:border-teal-500/40 transition-all text-teal-300">
          <Phone className="w-3.5 h-3.5 hover:text-white" />
          <span className="text-[9px] font-bold uppercase tracking-wider">Call</span>
        </button>
        <button onClick={(e) => { e.stopPropagation(); onBook('Appt', hospital); }} className="flex flex-col items-center justify-center gap-1 p-1.5 rounded-lg bg-[#0c2a23] hover:bg-teal-900 border border-teal-800/40 hover:border-teal-500/40 transition-all text-teal-300">
...
export default function PublicPortal() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-[#0c2a23] text-gray-100 flex flex-col font-sans">
      {/* Top Navbar */}
      <nav className="flex items-center justify-between px-4 py-2.5 bg-[#10362e] border-b border-teal-900/50 shadow-md">
      ...
      <main className="flex-1 flex flex-col lg:flex-row p-4 gap-4 min-h-0 overflow-hidden">
        ...
        <div className="w-full lg:w-[65%] flex flex-col gap-4 h-full min-h-0 overflow-hidden">
          {/* Header Banner */}
          <div className="flex items-center justify-between bg-[#134036] p-4 rounded-xl border border-teal-800/40 shadow-xl relative overflow-hidden">
          ...
          <div className="flex-1 min-h-0 rounded-xl border border-teal-800/40 relative shadow-2xl bg-[#0e3029] overflow-hidden">
            {locating ? (
              <div className="absolute inset-0 z-50 bg-[#134036]/90 backdrop-blur-md flex flex-col items-center justify-center text-teal-300">
            ...
            <div className="absolute bottom-4 right-4 px-3 py-1.5 bg-[#0c2a23]/90 backdrop-blur-sm text-xs font-semibold text-teal-400/80 rounded-full shadow border border-teal-800/50 z-[1000] drop-shadow-xl">
        ...
        <div className="w-full lg:w-[420px] lg:flex-1 shrink-0 pb-2 flex flex-col h-full rounded-xl min-h-0">
          ...
          <div className="mb-3 relative shrink-0">
            ...
            <input 
              ...
              className="w-full bg-[#134036] border border-teal-800/40 text-teal-50 px-9 py-2.5 rounded-lg outline-none focus:border-teal-500/60 focus:ring-1 focus:ring-teal-500/60 transition-all placeholder:text-teal-600 shadow-inner text-sm"
            />
          </div>
      ...
      {/* SOS Modal */}
      {sosModalOpen && (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center bg-[#0c2a23]/90 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-gradient-to-br from-rose-950 to-[#0f2720] border border-rose-800 shadow-2xl rounded-2xl w-full max-w-lg overflow-hidden shadow-[0_0_50px_rgba(225,29,72,0.2)]">
            ...
            <div className="p-6 space-y-4">
                ...
                <>
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-[#081a14] border border-rose-900/50 rounded-lg px-4 py-3 text-white focus:border-rose-500 focus:outline-none"
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <select 
                        ...
                        className="w-full bg-[#081a14] border border-rose-900/50 rounded-lg px-4 py-3 text-white focus:border-rose-500 focus:outline-none appearance-none"
                      >
                    ...
                    <div>
                      ...
                      <div className="h-[46px] flex items-center gap-3 bg-[#081a14] border border-rose-900/50 rounded-lg px-4">
                        <input 
                          type="checkbox" 
                          id="accident"
              ...
              {sosStatus === 'accepted' && sosDriverInfo && (
                <div className="text-center py-6">
                  ...
                  <div className="bg-[#081a14] p-4 rounded-xl border border-teal-900 text-left">
              ...
              {(sosStatus as any) === 'arrived' && (
                <div className="text-center py-6">
                  ...
                  {sosDriverInfo && (
                    <div className="bg-[#081a14] p-4 rounded-xl border border-emerald-900/60 text-left mb-4">
      ...
      {bookingModal.isOpen && bookingModal.hospital && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0c2a23]/80 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-[#134036] border border-teal-700/50 shadow-2xl rounded-2xl w-full max-w-md overflow-hidden shadow-[0_0_50px_rgba(20,184,166,0.15)] relative">
            <div className="p-6">
              ...
              <div className="bg-[#0e3029] rounded-xl p-4 mb-6 border border-teal-800/40">
              ...
              {bookingStatus === 'success' ? (
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <input 
                    ...
                    className="w-full bg-[#0c2a23] border border-teal-800/60 rounded-lg px-4 py-2.5 text-white outline-none focus:border-teal-500 placeholder:text-teal-700"
                  />
                  <input 
                    type="tel" 
                  ...
                  <textarea 
                    ...
                    className="w-full bg-[#0c2a23] border border-teal-800/60 rounded-lg px-4 py-2.5 text-white outline-none focus:border-teal-500 placeholder:text-teal-700 resize-none h-20"
                  />
