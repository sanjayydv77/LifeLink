    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div className="relative">
        ...
        <input
          ...
          maxLength={maxLength}
          className="w-full bg-[#081e15] border border-teal-800/40 rounded-xl pl-10 pr-10 py-3 text-white placeholder-teal-700/50 text-sm focus:outline-none focus:border-teal-500/70 focus:ring-1 focus:ring-teal-500/30 transition-all"
        />
        {isPass && (
...
export default function AuthPage({ onAuth }: { onAuth: (user: any) => void }) {
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className="w-full bg-[#081e15] border border-teal-800/40 rounded-xl px-4 py-4 text-white text-center text-2xl tracking-[0.5em] font-mono focus:outline-none focus:border-teal-500/70 focus:ring-1 focus:ring-teal-500/30 transition-all"
        />
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#0c2a23] flex items-center justify-center p-4 relative overflow-hidden">
      {/* Background glow */}
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Card */}
        <div className="bg-[#113c33]/80 backdrop-blur-xl border border-teal-700/30 rounded-3xl shadow-2xl shadow-teal-900/30 overflow-hidden">
          {/* Tabs */}
