                ...
                <div key={h.id} className="bg-gradient-to-br from-[#134036] to-[#0d2f28] border border-teal-800/40 rounded-xl p-4 shadow-lg hover:border-teal-600/50 transition-all">
                  ...
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="flex flex-col items-end gap-1 shrink-0 ml-2">
                      <div className="px-2 py-1 bg-teal-900/50 rounded border border-teal-900 flex items-center gap-1 font-mono text-[10px] text-teal-300 font-bold"><Clock className="w-2.5 h-2.5"/>{h.eta}</div>
